  ...
  return (
    <section className="bg-white !py-6 md:!py-16 px-4 md:px-10 relative">
      ...
      <div className="!w-[300px] md:!w-[500px] !m-auto !mt-5 relative">
        ...
        {dropdownOpen && (
          <div className="absolute !px-5 mt-2 bg-[#0659a6]  rounded-md shadow-lg z-50">
            <a
              href={whatsappGroupLink}
              target="_blank"
              rel="noopener noreferrer"
              className="block !px-4 !py-2 hover:bg-gray-100   ">
              <span className="flex items-center hover:text-black text-white justify-evenly ">
                Join via WhatsApp
              </span>
            </a>
            <a
              ...
              rel="noopener noreferrer"
              className="block !px-4 !py-2 hover:bg-gray-100 ">
              <span className="flex hover:text-black items-center text-white justify-evenly">
                Join via Telegram
              </span>
            </a>
          </div>
